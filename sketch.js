...
player2.addAnimation("player",player2Img2);
player2.addAnimation("player2p",player2Img);
player2.scale = 3;
...
{ 
  player2.x = 600;
  player2.changeAnimation("player2p",player2Img)
}
...
{
  counter2 = counter2+0.25;
console.log(counter2);
}
switch(counter){
  case 1:health.changeAnimation("health80S1",health80img)
  player1.x = 500;
  player1.changeAnimation("player1",player1Img1)
  counter = 2
  break;
  case 3:health.changeAnimation("health60S1",health60img)
  player1.x = 500;
  player1.changeAnimation("player1",player1Img1)
  counter = 4
  break;
  case 5:health.changeAnimation("health40S1",health40img)
  player1.x = 500;
  player1.changeAnimation("player1",player1Img1)
  counter = 6
  break;
  case 7:health.changeAnimation("health20S1",health20img)
  player1.x = 500;
  player1.changeAnimation("player1",player1Img1)
  counter = 8
  break;
  case 9:health.changeAnimation("health0",health0img)
  player1.x = 500;
  player2.changeAnimation("player",player2Img2);
  break;
  default:break;
}
switch(counter2){
  case 1:health.changeAnimation("health80S2",health80img)
  player2.x = 500;
  player2.changeAnimation("player2",player2Img1);
  counter = 2
  break;
  case 3:health.changeAnimation("health60S2",health60img)
  player1.x = 500;
  player2.changeAnimation("player2",player2Img1);
  counter = 4
  break;
  case 5:health.changeAnimation("health40S2",health40img)
  player1.x = 500;
  player2.changeAnimation("player2",player2Img1);
  counter = 6
  break;
  case 7:health.changeAnimation("health20S2",health20img)
  player1.x = 500;
  player2.changeAnimation("player2",player2Img1);
  counter = 8
  break;
  case 9:health.changeAnimation("health0S2",health0img)
  player1.x = 500;
  player2.changeAnimation("player2",player2Img1);
  break;
  default:break;
